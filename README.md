...
[Tar file](https://github.com/bytemystery-com/sshproxy/releases/download/v0.3.0/SshProxy.tar.xz)  
[Standalone binary](https://github.com/bytemystery-com/sshproxy/releases/download/v0.3.0/SshProxy)  

#### Windows (64 Bit)

[Standalone exe](https://github.com/bytemystery-com/sshproxy/releases/download/v0.3.0/SshProxy.exe)  
...
[APK all in one](https://github.com/bytemystery-com/sshproxy/releases/download/v0.3.0/SshProxy.apk)  
[APK only 64 bit](https://github.com/bytemystery-com/sshproxy/releases/download/v0.3.0/SshProxy_64.apk)  
